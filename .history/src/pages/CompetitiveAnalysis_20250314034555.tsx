...
export default function CompetitiveAnalysis() {
  ...
  async function loadBusinessData() {
    try {
      setLoading(true);
      // For a real app, we would get the business ID from context or URL params
      ...
      try {
        ...
        if (businessData) {
          ...
          // Get competitors from the business data
          const competitorsData = businessData.competitors || [];
          ...
          // No business found for this ID, fall back to mock data
