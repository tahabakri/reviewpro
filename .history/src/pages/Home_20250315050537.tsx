                ...
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between mb-1">
                      <span>Positive</span>
                      <span>{(businessDetails.sentimentAnalysis.positive * 100).toFixed(1)}%</span>
                    </div>
                    <div className="h-2 bg-gray-200 rounded-full">
                      <div
                        className="h-full bg-green-500 rounded-full"
                        style={{ width: `${businessDetails.sentimentAnalysis.positive * 100}%` }}
                      />
                    </div>
                  </div>
                  <div>
                    <div className="flex justify-between mb-1">
                      <span>Neutral</span>
                      <span>{(businessDetails.sentimentAnalysis.neutral * 100).toFixed(1)}%</span>
                    </div>
                    <div className="h-2 bg-gray-200 rounded-full">
                      <div
                        className="h-full bg-yellow-500 rounded-full"
                        style={{ width: `${businessDetails.sentimentAnalysis.neutral * 100}%` }}
                      />
                    </div>
                  </div>
                  <div>
                    <div className="flex justify-between mb-1">
                      <span>Negative</span>
                      <span>{(businessDetails.sentimentAnalysis.negative * 100).toFixed(1)}%</span>
                    </div>
                    <div className="h-2 bg-gray-200 rounded-full">
                      <div
                        className="h-full bg-red-500 rounded-full"
                        style={{ width: `${businessDetails.sentimentAnalysis.negative * 100}%` }}
                      />
                    </div>
                  </div>
                </div>
