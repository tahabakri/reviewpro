              ...
              {[
                {
                  ...
                  a: 'Get full access to all features for 3 days. After the trial ends, you\'ll need to select a subscription plan to continue using the service.',
                },
                {
                  q: 'What happens after my trial ends?',
                  a: 'You\'ll be prompted to choose a subscription plan. Your account will be limited until you select and pay for a plan.',
                },
                {
