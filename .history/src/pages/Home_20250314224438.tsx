...
const Home: React.FC = () => {
  ...
  const handleAnalyzeReviews = () => {
    const data = mockGooglePlacesData[googlePlacesId];
        ...
        >
          <motion.div variants={slideUp}>
            <Card variant="glass" className="p-8 h-full">
              ...
              <div className="text-5xl font-bold text-primary-indigo">4.5</div>
              <div className="text-gray-600 dark:text-gray-300">Based on 1,234 reviews</div>
            </Card>
          </motion.div>
