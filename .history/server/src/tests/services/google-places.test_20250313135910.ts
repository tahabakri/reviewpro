...
import { createMockResponse, MockTextSearchResponse, MockPlaceDetailsResponse } from '../types';
import { 
  mockSearchResponse, 
  mockDetailsResponse, 
...
describe('GooglePlacesService', () => {
  ...
  describe('searchCompetitors', () => {
    it('should return formatted competitor data', async () => {
      mockClient.textSearch.mockResolvedValueOnce(mockSearchResponse as TextSearchResponse);
  ...
  describe('getReviews', () => {
    it('should return formatted review data', async () => {
      mockClient.placeDetails.mockResolvedValueOnce(mockDetailsResponse as typeof mockDetailsResponse & { config: any });
    ...
    it('should handle missing reviews', async () => {
      mockClient.placeDetails.mockResolvedValueOnce(mockEmptyDetailsResponse as typeof mockEmptyDetailsResponse & { config: any });
