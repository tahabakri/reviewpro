...
type MockedLanguageClient = jest.Mocked<LanguageServiceClient>;
...
describe('ETLPipeline', () => {
  ...
  let mockLanguageClient: MockedLanguageClient;

  beforeEach(() => {
    mockLanguageClient = new LanguageServiceClient() as MockedLanguageClient;
