...
import { MockLanguageClient, createMockLanguageClient } from '../mocks/language-client.mock';
...
describe('ETLPipeline', () => {
  ...
  let mockLanguageClient: jest.Mocked<MockLanguageClient>;
  ...
  beforeEach(() => {
    jest.clearAllMocks();
    mockLanguageClient = createMockLanguageClient() as jest.Mocked<MockLanguageClient>;
