...
export class SentimentController {
  ...
  constructor(
    ...
    const gemini = GeminiClient.getInstance(geminiApiKey);
    this.analyzer = new SentimentAnalyzer(gemini, redisClient);
  }

  async analyzeSingleReview = async (req: Request, res: Response): Promise<void> => {
    try {
  ...
  async analyzeBusinessReviews = async (req: Request, res: Response): Promise<void> => {
    try {
  ...
  async getBatchAnalysis = async (req: Request, res: Response): Promise<void> => {
    try {
  ...
  async getReviewStats = async (req: Request, res: Response): Promise<void> => {
    try {
      const { placeId } = req.params;
      const { 
        startDate,
