              ...
              <div className="space-y-4">
                {step === 3 && (
                  <p className="text-sm text-center text-gray-500 dark:text-gray-400">
                    By creating an account, you agree to start your 3-day free trial.
                    After the trial ends, you'll need to select a subscription plan to continue using ReviewPro.
                  </p>
                )}
                <Button
                ...
                >
                  {step === 3 ? 'Start My Free Trial' : 'Continue'}
                </Button>
              </div>
            </div>
