...
const Navbar: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setIsDarkMode(storedTheme === 'dark' || (!storedTheme && darkModePreference.matches));
  ...
  return (
    <nav className="sticky top-0 z-50 transition-colors">
      <div className="glass glass-dark shadow-lg">
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex md:items-center md:space-x-4">
              <button
                ...
                className="p-2 rounded-lg text-gray-700 hover:text-primary-indigo dark:text-gray-300 dark:hover:text-primary-purple focus-ring"
        ...
        {/* Mobile menu */}
        {isMenuOpen && (
          <div className="md:hidden glass glass-dark border-t border-gray-200 dark:border-gray-700">
